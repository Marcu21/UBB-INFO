...
void testAdaugaInexistente()
{
    ...
    Dictionar d2;
    assert(d2.adauga(10, 100) == NULL_TVALOARE);
    assert(d2.adauga(3, 300) == NULL_TVALOARE);
    assert(d2.adauga(-3, -30) == NULL_TVALOARE);
    assert(d2.adauga(21, 24) == NULL_TVALOARE);
    assert(d2.adauga(-3, -3) == -30);

    int added = d.adaugaInexistente(d2);
    assert(added == 2);
    assert(d.dim() == 6);
    assert(d.cauta(3) == 300);
    assert(d.cauta(10) == 10);
    assert(d.cauta(21) == 24);
}
