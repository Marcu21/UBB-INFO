...
class InchiriereFilme:
    ...
    def raport_filme_inchiriate_clienti_nume(self):
        lista_clienti_sortata_nume = sorted(self.__repo_clienti.get_all(), key=lambda x: x.get_nume())
    ...
    def raport_filme_inchiriate_clienti_nrfilme(self):
        lista_clienti_descrescatoare_nrfilme = sorted(self.__client_inchiriere, key=lambda x: x[1],
                                                      reverse=True)
    ...
    def raport_filme_inchiriate(self):
        lista_filme_inchiriate_descrescator = sorted(self.__filme_inchiriate, key=lambda x: x[1],
                                                     reverse=True)
