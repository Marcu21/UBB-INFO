...
film_service = FileFilmService(repo_filme, validator_film)

repo_clienti = FileClientRepository()
validator_client = ValidatorClienti()
client_service = FileClientService(repo_clienti, validator_client)

inchiriere_filme = FileInchiriereFilme(repo_filme, repo_clienti)
...
def run_ui_file():
        ...
        while True:
            ...
            if choice == "1":
                ...
                film_service.sortare_filme()

            elif choice == "10":
                repo_filme.incarca_date()
